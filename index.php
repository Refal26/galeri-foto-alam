...
<body>
    ...
    <header>
        <div class="container">
        <h1><a href="index.php">GALERI FOTO ALAM </a></h1>
        <ul>
            <li><a href="galerialam.php">Galeri ALAM</a></li>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="box">
				...
				?>
                    <a href="galerialam.php?kat=<?php echo $k['category_id'] ?>">
                        <div class="col-5">
